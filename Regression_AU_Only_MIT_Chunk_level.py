...
# parameters
la = "Overall"  #Name of Label, as we have 5 labels to work (O,R,Ex,Ey and F)
l_sec = 60   #Chunk-size
...
file_path = "Path for Data File......."  #We have a created an npy array for AU+Kineme Data that need to be passed here as Data_60_Overall.npy
...
labe_path = "Path for Label..........."   #For eg: Label_60_Overall.npy
